<section class="max-w-screen-md">
    <div class="px-4 mb-2 flex items-center justify-end w-full container-serach-field" x-data="{ focus: false }">
        ...
        <x-jet-label class="ml-2" for="search-field" @click="focus = true">
            ...
            <x-table.trow type="">
                ...
                <x-table.tdata>
                    <x-jet-dropdown align="right" width="60" dropdownClasses="!z-50">
                        ...
                        <x-slot name="content">
                            <div class="">
                                <x-jet-dropdown-link href="{{route('books.edit',$book->id )}}" class="flex items-center">
