...
<x-jet-form-section submit="save">
    ...
    <x-slot name="form">
        ...
        <section class="col-span-5 flex flex-wrap w-full ">
            ...
            <x-jet-input type="text" class="w-full" id="title" wire:model="book.title" value="{{$book->title}}" />
        ...
        <section class="col-span-5 flex flex-wrap w-full ">
            ...
            <x-jet-input type="date" class="w-full" id="release" wire:model="book.release" value="{{date('Y-m-d',strtotime($book->release))}}" />
        ...
        <section class="col-span-5 flex flex-wrap w-full ">
            ...
            <x-forms.textarea id="resume" class="w-full" wire:model="book.resume">{{$book->resume}}</x-forms.textarea>
            <x-jet-input-error for="book.resume" />
        </section>
    </x-slot>
    <x-slot name="actions">
        <section class="flex flex-wrap justify-end w-full px-2 pb-3">
            <x-jet-action-message on="bookSaved" class="flex items-center">
