...
<x-jet-form-section submit="save">
    ...
    <x-slot name="form">
        ...
        <section class="col-span-5 flex flex-wrap w-full ">
            ...
            <x-jet-input type="text" class="w-full" id="title" wire:model="book.title" />
        ...
        <section class="col-span-5 flex flex-wrap w-full ">
            ...
            <x-jet-input type="date" class="w-full" id="release" wire:model="book.release" />
        ...
        <section class="col-span-5 flex flex-wrap w-full ">
            ...
            <x-forms.textarea id="resume" class="w-full" wire:model="book.resume"></x-forms.textarea>
