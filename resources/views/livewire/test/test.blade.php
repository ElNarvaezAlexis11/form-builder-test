            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-row">
                    ...
                    <div class="flex justify-center mt-8">
                        ...
                        <div class="w-full" x-data="alpineMuliSelect({selected:['te_11', 'te_12'], elementId:'multSelect-{{$index}}'})" x-init="$watch('selectedElms', (values) => {
                                let simpleValue = values.map( (value) => value.value);
                                console.log(simpleValue);
                                @this.set('props.{{$index}}.values', simpleValue);
                            })">

                            <!-- Select Options -->
                            <select class="hidden" id="multSelect-{{$index}}">
                                            ...
                                            <div class="my-2 p-1 flex border border-gray-200 bg-white rounded-md">
                                                <div class="flex flex-auto flex-wrap" x-on:click="open">
                                                    ...
                                                    <div x-show="selectedElms.length == 0" class="flex-1">
                                                        <input placeholder="Select teams" class="bg-transparent p-1 px-2 appearance-none outline-none h-full w-full text-gray-800" x-bind:value="selectedElements()">
                                                    </div>
                                                </div>
