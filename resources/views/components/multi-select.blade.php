...
<div class="flex justify-center mt-8">
    ...
    <div class="w-full" x-data="alpineMuliSelect({selected:{{ $selecteds }}, elementId:'multi-select-{{$id}}'})" x-init="$watch('selectedElms', (values) => {
                                let simpleValue = values.map( (value) => value.value);
                                console.log(simpleValue);
                                @this.set('props.{{$id}}.values', simpleValue);
                            })">
