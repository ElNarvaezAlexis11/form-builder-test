 <div class="pt-2 pb-3 space-y-1">
     ...
     <x-jet-responsive-nav-link href="{{ route('paintings.index') }}" :active="request()->routeIs('paintings.*')">
         {{ __('paintings') }}
     </x-jet-responsive-nav-link>
     <x-jet-responsive-nav-link href="{{ route('documents.index') }}" :active="request()->routeIs('documents.*')">
         {{ __('Documents') }}
     </x-jet-responsive-nav-link>
     <x-jet-responsive-nav-link href="{{ route('forms.index') }}" :active="request()->routeIs('forms.*')">
        {{ __('Forms') }}
    </x-jet-responsive-nav-link>
 </div>
